...
@WebServlet(name = "Change Password", value = "/profile/change-password")
public class ChangePasswordServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/WEB-INF/view/change-password.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        usersService.changePassword(ServletUtils.getSessionUser(req), oldPassword, newPassword,
                getChangeCredentialsResultHandler(req, resp));
    }
                ...
                try {
                    switch (errorCode) {
                        case INCORRECT_CREDENTIALS:
                            ...
                            break;
                        case SERVER_ERROR:
                            System.out.println("Failed to change password due to server error");
                            break;
                    }
                } catch (IOException ioException) {
                    System.out.println("Failed to redirect user");
